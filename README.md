...
This is a Vite template on top of the official [Vite](https://vitejs.dev/) [react-ts](https://stackblitz.com/edit/vitejs-vite-is3dmk?file=index.html&terminal=dev) template (`npm init vite@latest myapp -- --template react-ts`) and some extended setup.  
...
- [eslint-config-ts-prefixer](https://github.com/laststance/eslint-config-ts-prefixer). Specialized fixable(`--fix` option) rule sets. Zero extend any recommended for comfortable DX.
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/amitd291"><img src="https://avatars.githubusercontent.com/u/18529185?v=4?s=100" width="100px;" alt="Amit"/><br /><sub><b>Amit</b></sub></a><br /><a href="https://github.com/laststance/create-react-app-vite/commits?author=amitd291" title="Documentation">📖</a></td>
    </tr>
  </tbody>
</table>
